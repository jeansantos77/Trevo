...
export class CorFormComponent {
  ...
  ngOnInit() {
    ...
    if (this.entityId) {
      this.corService.getById(this.entityId).subscribe((data: any) => {
  ...
  Save(): void {
    ...
    if (this.entityForm.valid) {
      ...
      if (this.entityId > 0) {
        this.corService.update(entity).subscribe(() => {
        ...
        this.corService.add(entity).subscribe(() => {
