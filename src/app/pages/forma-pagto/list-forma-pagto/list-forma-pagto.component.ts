...
@Component({
  ...
  templateUrl: './list-forma-pagto.component.html',
  styleUrl: './list-forma-pagto.component.scss'
})


export class ListFormaPagtoComponent implements OnInit, AfterViewInit {
  _liveAnnouncer = inject(LiveAnnouncer);
  dialog = inject(MatDialog);
  toastr = inject(ToastrService);
  formaPagtoService = inject(FormaPagtoService);
  router = inject(Router);

  formName: string = "Forma de Pagamento";
  buttonTooltip: string = "Cria um novo " + this.formName;
  entityPage: string = "/forma-pagto-form";

  displayedColumns: string[] = ['id', 'descricao', 'action'];
  dataSource = new MatTableDataSource<IFormaPagto>();
  ...
  loadData() {
    this.formaPagtoService.getAll().subscribe(data => {
  ...
  openDeleteConfirmation(id: number): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.formaPagtoService.delete(id).subscribe(() => {
