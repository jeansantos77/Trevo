...
@Component({
  ...
  styleUrl: './acessorio-form.component.scss',
  standalone: true,
  imports: [
    MatInputModule,
    MatButtonModule,
...
export class AcessorioFormComponent {
  ...
  listPage: string = "/list-acessorio"
  ...
  ngOnInit() {
    ...
    if (this.entityId) {
      this.acessorioService.getById(this.entityId).subscribe((data: any) => {
  ...
  Save(): void {
    ...
    if (this.entityForm.valid) {
      ...
      if (this.entityId > 0) {
        this.acessorioService.update(entity).subscribe(() => {
        ...
        this.acessorioService.add(entity).subscribe(() => {
