...
@Component({
  ...
  templateUrl: './list-acessorio.component.html',
  styleUrl: './list-acessorio.component.scss'
})


export class ListAcessorioComponent implements OnInit, AfterViewInit {
  ...
  formName: string = "Acessório";
  buttonTooltip: string = "Cria um novo " + this.formName;
  entityPage: string = "/acessorio-form";

  displayedColumns: string[] = ['id', 'descricao', 'action'];
  dataSource = new MatTableDataSource<IAcessorio>();
  ...
  loadData() {
    this.acessorioService.getAll().subscribe(data => {
