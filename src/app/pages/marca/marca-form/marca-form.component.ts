...
export class MarcaFormComponent {
  ...
  ngOnInit() {
    ...
    if (this.entityId) {
      this.marcaService.getById(this.entityId).subscribe((data: any) => {
  ...
  Save(): void {
    ...
    if (this.entityForm.valid) {
      ...
      if (this.entityId > 0) {
        this.marcaService.update(entity).subscribe(() => {
        ...
        this.marcaService.add(entity).subscribe(() => {
